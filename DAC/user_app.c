...
void UserAppRun(void)
{
    ...
    DAC1DATL = au8DigitalSineTable[u8Index];
    u8Index += 0x04;
    ...
    /* Sawtooth Waveform */
#if 0
    static int TransitionBit = 0;
    
    if(DAC1DATL < 0xFF && TransitionBit == 0)
        DAC1DATL++;
    else if(DAC1DATL == 0xFF)
        TransitionBit = 1;
    
    if(DAC1DATL > 0x00 && TransitionBit == 1)
        DAC1DATL--;
    else if(DAC1DATL == 0x00)
        TransitionBit = 0;
#endif
